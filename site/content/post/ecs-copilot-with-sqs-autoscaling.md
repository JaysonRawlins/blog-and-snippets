...
ECS Copilot: ECS Copilot that has been overridden to expose CDK. See svc override — AWS Copilot CLI. Probably could use the same principles with regular CDK as well but this particular example assumes we are using ECS Copilot.
Typescript
CDK v2
NPM
